...
p034x= p034[4:10]
t034x= t034[4:10]
p034y = np.append(p034x,[p029x[0]])
t034y = np.append(t034x,[t029x[0]])
...
plt.plot(p018x, t018x, color='green', linewidth=2, label="-2 krad/s")
...
plt.plot(p008x, t008x, color='red', linewidth=2, label="-1 krad/s")
...
plt.plot(p001x, t001x, color='blue', linewidth=2, label="0 krad/s")
...
plt.plot(p021x, t021x, color='black', linewidth=2, label="+1 krad/s")
...
plt.plot(p034y, t034y, color='cyan', linewidth=2, label = "+2 krad/s")
