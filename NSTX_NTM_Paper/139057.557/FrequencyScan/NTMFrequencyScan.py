...
plt.axvline(x=-19.9, color='red', linestyle='dashed', label='$m=3; \\varpi_e = -19.9$ krad/s')
plt.axvline(x=2.5, color='green', linestyle='dashed', label='$m=4; \\varpi_e  = 2.5$ krad/s')
plt.axvline(x=13.7, color='blue', linestyle='dashed', label='$m=5; \\varpi_e  = 13.7$ krad/s')
plt.axvline(x=19.2, color='cyan', linestyle='dashed', label='$m=6; \\varpi_e  = 19.2$ krad/s')
plt.axvline(x=23.0, color='magenta', linestyle='dashed', label='$m=7; \\varpi_e  = 23.0$ krad/s')
