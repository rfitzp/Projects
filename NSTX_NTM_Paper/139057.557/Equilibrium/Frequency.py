...
plt.plot(psin[1], wl[1], 'ro', markersize=7, label="$m=3$; $\\varpi_e = -19.9$ krad/s")
plt.plot(psin[2], wl[2], 'go', markersize=7, label="$m=4$; $\\varpi_e = 2.5$ krad/s")
plt.plot(psin[3], wl[3], 'bo', markersize=7, label="$m=5$; $\\varpi_e = 13.7$ krad/s")
plt.plot(psin[4], wl[4], 'co', markersize=7, label="$m=6$; $\\varpi_e = 19.2$ krad/s")
plt.plot(psin[5], wl[5], 'mo', markersize=7, label="$m=7$; $\\varpi_e = 23.0$ krad/s")
