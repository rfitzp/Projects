...
mu       = 0.      # No noninductive current drive
pc       = 0.      # Dummy value
...
i12 = []
i22 = []
for Delta1 in np.linspace(d1_start, d1_mid, Nd1):
    ...
    ep2.append(Eps2)
    lpl.append(l_plus)
    lpd.append(l_plus/Delta1)
    i11.append(I11)
    i12.append(I12)
    i22.append(I22)
    print ("Delta_1 = %11.4e  F_+ = %11.4e  feval = %2d  epsilon_2 = %11.4e  lambda = %11.4e  lambda/Delta_1 = %11.4e" \
           % (Delta1, f_plus, feval, Eps2, l_plus, l_plus/Delta1))

for Delta1 in np.linspace(d1_mid, d1_end, Nd1):
...
# Output data
# ###########
with open("Intrinsic.txt", "w") as file:
    for n in range(len(ddd)):
        file.write("%11.4e %11.4e %11.4e %11.4e %11.4e %11.4e %11.4e\n" % (ddd[n], ep2[n], lpl[n], lpd[n], i11[n], i12[n], i22[n]))
