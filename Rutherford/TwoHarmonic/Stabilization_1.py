...
# ######################
mu_end   = 0.      # mu scan end value
Nmu      = 101     # Number of points in mu scan
...
val1, val2, val3, val4, val5, val6 = input("pc  Delta_1  Delta_2  epsilon_2  mu_start  verbose?? ").split()
pc = float(val1)
Delta1 = float(val2)
Delta2 = float(val3)
Eps2_old = float(val4)
...
# Output data
# ###########
with open("Stabilization_1.txt", "w") as file:
